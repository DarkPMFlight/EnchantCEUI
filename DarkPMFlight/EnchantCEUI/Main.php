...
namespace UnknownOre\EnchantCEUI;
...
use DarkPMFlight\EnchantUI\libs\jojoe77777\FormAPI\{
 ...
 * @package DarkPMFlight\EnchantUI
...
class Main extends PluginBase{
    ...
    */
    ...
    public function listForm(Player $player): void{
        ...
        $form->setTitle("§l§b♦ §fCustonEnchant §bShop §b♦");

        $form->setContent("§l§c↣ §eYour Money: §f$".$money);
